...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-category-add">
		...
		<input type="hidden"  value="<?php echo $this->data['st']; ?>" name="st">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo $this->data['cnname']; ?>" <?php if($this->data['st'] == '1'){ echo 'disabled'; }?>  placeholder="" id="cnname" name="cnname">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-3 col-sm-2">
						...
						英文名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo $this->data['enname']; ?>" <?php if($this->data['st'] == '1'){ echo 'disabled'; }?> placeholder="" id="enname" name="enname">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select" id="type" <?php if($this->data['st'] == '1'){ echo 'disabled'; }?> name="type">
							<option value>请选择类型</option>
							<option <?php if($this->data['type'] == 1){ echo 'selected="selected"';} ?>  value="1">单行文本</option>
							<option <?php if($this->data['type'] == 2){ echo 'selected="selected"';} ?> value="2">多行文本</option>
							<option <?php if($this->data['type'] == 3){ echo 'selected="selected"';} ?>  value="3">单按钮</option>
						</select>
						</span>
					</div>
					<div class="col-3">
				...
				<div class="row cl">
					<label class="form-label col-xs-3 col-sm-2">
						配置可选值：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo $this->data['kxvalue']; ?>" placeholder="用英文逗号分隔" id="kxvalue" name="kxvalue">
					</div>
					<div class="col-3">
					</div>
				</div>
